...
def sniper(token):
    ...
    print(f'''
{Fore.LIGHTYELLOW_EX}[*] READY TO SNIPER{Fore.RESET}
{Fore.LIGHTMAGENTA_EX}[*] Update 2.0 {Fore.RESET}
{Fore.LIGHTGREEN_EX}[*] PROGRAM BY. THEENA{Fore.RESET}{Fore.RED} - {Fore.RESET}{Fore.LIGHTCYAN_EX}[*] DEV Aileen {Fore.RESET}
CRACKED BY JJTxStore
...
{Fore.GREEN}░ ░▒  ░ ░░ ░░   ░ ▒░░ ▒ ░░▒ ░     ░ ░ ░    ░▒ ░ ▒ {Fore.RESET}   {Fore.RED}    ░ ░░    ░ ▒ ▒░ ░░▒░ ░ ░    ░  ▒    ▒ ░▒░ ░░ ░ ░    ░▒ ░ ▒ {Fore.RESET}
{Fore.GREEN}░  ░  ░     ░   ░ ░ ░ ▒ ░░░           ░    ░░   ░ {Fore.RESET}   {Fore.RED}       ░  ░ ░ ░ ▒   ░░░ ░ ░  ░         ░  ░░ ░    ░    ░░   ░ {Fore.RESET}
        {Fore.LIGHTMAGENTA_EX}PHONE {Fore.RED}-{Fore.RESET} {Fore.CYAN}[{Fore.RESET}{Fore.LIGHTBLUE_EX}{phonenum[:5]}*****{Fore.RESET}{Fore.CYAN}]{Fore.RESET} {Fore.RESET}
    ''')
    while 1:
            ...
            if packet["t"] == "MESSAGE_CREATE":
                ...
                if len(message) >= 1:
                    ...
                    if d.status_code == 200:
                        ...
                        try:
                            post(config["webhook"],json={"content": None,"embeds": [{"title": f"ERROR | {d['status']['message']}","description":f"{messagx}","color": 16711680}]})
                        except:pass
